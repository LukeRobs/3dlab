...
export default function HeroCarousel() {
  ...
  if (loading) {
    return (
      <div className="w-full bg-gray-100 dark:bg-[#111111] animate-pulse" style={{ aspectRatio: '3/1', minHeight: '180px' }} />
    );
  }

  if (slides.length === 0) {
    return (
      <div className="w-full flex items-center justify-center bg-gray-100 dark:bg-[#111111]" style={{ aspectRatio: '3/1', minHeight: '180px' }}>
